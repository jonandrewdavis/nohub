/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4af3fcef9b554842a4548934f38d7dd5)
// Runtime types generated with workerd@1.20251125.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "NohubContainer";
	}
	interface Env {
		NOHUB_GAMES: "friendgem Friend Gem";
		NOHUB_METRICS_HOST: "10.0.0.1";
		NOHUB_TCP_HOST: "10.0.0.1";
		NOHUB_METRICS_ENABLED: "false";
		NOHUB_CONTAINER: DurableObjectNamespace<import("./src/index").NohubContainer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NOHUB_GAMES" | "NOHUB_METRICS_HOST" | "NOHUB_TCP_HOST" | "NOHUB_METRICS_ENABLED">> {}
}
